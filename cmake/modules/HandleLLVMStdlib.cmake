...
if(NOT DEFINED LLVM_STDLIB_HANDLED)
  ...
  if(LLVM_ENABLE_LIBCXX OR LLVM_ENABLE_LIBCXX_LIBCXXABI)
    if(LLVM_COMPILER_IS_GCC_COMPATIBLE)
      ...
      append_if(LLVM_ENABLE_LIBCXX_LIBCXXABI "-lc++abi" CMAKE_EXE_LINKER_FLAGS)
      append_if(LLVM_ENABLE_LIBCXX_LIBCXXABI "-lc++abi" CMAKE_SHARED_LINKER_FLAGS)
      append_if(LLVM_ENABLE_LIBCXX_LIBCXXABI "-lc++abi" CMAKE_MODULE_LINKER_FLAGS)
    else()
